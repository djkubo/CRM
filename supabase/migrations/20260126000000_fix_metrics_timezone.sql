-- Fix timezone inconsistency and recovery list in dashboard_metrics
-- Migration: 20260126000000_fix_metrics_timezone.sql
-- Date: 2026-01-26
-- Purpose: Fix timezone to use UTC consistently and improve recovery list query
...
COMMENT ON FUNCTION public.dashboard_metrics() IS 'Dashboard metrics with UTC timezone and improved recovery list (fixed 2026-01-26)';
